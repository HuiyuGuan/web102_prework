...
function filterUnfundedOnly() {
    ...
    let gameNotMetGoal = GAMES_JSON.filter((game) => {
        return game.pledged < game.goal;
    });

    // use the function we previously created to add the unfunded games to the DOM
    addGamesToPage(gameNotMetGoal);
}
...
function filterFundedOnly() {
    ...
    let gameMetGoal = GAMES_JSON.filter((game) => {
        return game.pledged >= game.goal;
    });

    // use the function we previously created to add unfunded games to the DOM
    addGamesToPage(gameMetGoal);
}
...
const displayStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${totalGames} games, Currently, ${numOfUnfundedGames} game remains unfunded. We need your help to fund these amazing games!`
